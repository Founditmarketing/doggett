        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8 items-center">
          ...
          <div className="lg:col-start-8 lg:col-span-5 flex flex-col justify-center">
            ...
            <div className="text-alabaster-muted font-light leading-loose text-sm md:text-base lg:text-lg mb-8 max-w-2xl flex flex-col gap-6">
              <ScrubText
                text="Headquartered in Alexandria, Louisiana, Doggett Law represents personal injury, family, and succession clients. My firm specializes in all matters, from beginning to end."
              />
              <ScrubText
                text="I have practice experience ranging from pre-suit negotiation all the way to filing writs with the Supreme Court. I recognize that the injuries you sustain impact not only you but your entire family."
              />
              <ScrubText
                text="Whether you're injured, navigating a complex divorce, or structuring legacy estate planning, I custom-tailor my aggressive litigation strategies to ensure your best interests are protected. I make myself available to speak with you directly about your case."
              />
            </div>
