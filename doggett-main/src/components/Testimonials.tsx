...
const testimonials = [
    ...
    {
        quote: "I am extremely grateful for his prompt and professional handling of emergency Power of Attorney papers. He was accessible, respectful, and highly effective when I needed him most.",
