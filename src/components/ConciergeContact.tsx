...
export default function ConciergeContact() {
  ...
  return (
    <section id="contact" className="py-24 md:py-32 bg-obsidian relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 relative z-10">
        <div className="text-center mb-20">
          ...
          >
            Submit preliminary details regarding your matter. All correspondence is strictly confidential and reviewed exclusively by me directly.
          </motion.p>
        </div>
        ...
        <div className="glass-panel relative overflow-hidden shadow-2xl">
          ...
          <form className="p-8 md:p-16 min-h-[450px] relative flex flex-col justify-center" onSubmit={(e) => e.preventDefault()}>
