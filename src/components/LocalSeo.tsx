...
export default function LocalSeo() {
  return (
    <section className="py-24 md:py-32 bg-obsidian-light relative overflow-hidden border-t border-white/5">
      <div className="absolute inset-0 bg-[url('/assets/hero_walking.png')] bg-cover bg-center opacity-10 mix-blend-luminosity grayscale"></div>
