    ...
    <div className="bg-obsidian min-h-screen text-alabaster pt-32 pb-24">
      ...
      <div className="relative h-[60vh] md:h-[75vh] w-full overflow-hidden mb-32 border-b border-white/5">
        ...
        <div className="absolute inset-0 z-20 flex flex-col items-center justify-center px-6 text-center">
          ...
          >
            Rooted in Alexandria. Feared in the courtroom. We do not settle for less than our clients deserve.
          </motion.p>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-6 md:px-12">
          ...
          <div className="flex flex-col md:flex-row gap-16 items-start">
            ...
            <div className="md:w-2/3 prose prose-invert max-w-none">
              ...
              <p className="text-lg text-alabaster-muted font-light leading-loose mb-6">
                For over three generations, the Doggett name has been synonymous with legal excellence in Rapides Parish and throughout Central Louisiana. Our lineage of jurisprudence provides us with an intrinsic understanding of the local judiciary—a tactical advantage that out-of-town mega-firms simply cannot replicate. 
              </p>
              <p className="text-lg text-alabaster-muted font-light leading-loose">
                We maintain a deliberately low case volume. This allows our senior attorneys to personally investigate, strategize, and litigate every single matter. You will not be relegated to a junior associate or a paralegal. When you engage Doggett Law, you engage elite counsel directly. We prepare every grievance, every divorce petition, and every succession dispute as if trial is inevitable. Paradoxically, it is this overwhelming readiness for war that forces the maximum pre-trial settlements our clients enjoy.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12 text-center">
             ...
             <p className="text-alabaster-muted font-light max-w-2xl mx-auto mb-10">We invite you to reach out for a strictly confidential consultation. Discover the exact tactical advantage a third-generation litigator brings to your legal battle.</p>
             <a href="/#contact" className="inline-flex items-center gap-4 group px-8 py-4 bg-champagne text-obsidian text-xs uppercase tracking-widest font-medium hover:bg-white transition-colors duration-500">
